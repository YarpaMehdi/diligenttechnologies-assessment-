...
function twenty_twenty_one_scripts() {
	...
	wp_enqueue_style( 'anax-default', get_template_directory_uri() . '/assets/css/default.css' );
	
	// Theme stylesheet.
	wp_enqueue_style( 'anax-style', get_stylesheet_uri() );
...
function block_editor_full_width() {
	echo '<style> .wp-block-post-title, .block-editor-block-list__layout > .wp-block { width: 100% !important; max-width: none !important;} .editor-styles-wrapper .editor-writing-flow { max-width: none !important; margin: 0 !important; } </style>';
}
